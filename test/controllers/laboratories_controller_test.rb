...
class LaboratoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laboratory" do
    assert_difference("Laboratory.count") do
      post laboratories_url, params: { laboratory: { coordinator_id: @laboratory.coordinator_id, registry_id: @laboratory.registry_id } }
    end
  ...
  test "should update laboratory" do
    patch laboratory_url(@laboratory), params: { laboratory: { coordinator_id: @laboratory.coordinator_id, registry_id: @laboratory.registry_id } }
